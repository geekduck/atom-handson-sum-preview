AtomHandsonSumPreview = require '../lib/atom-handson-sum-preview'
  ...
  describe "when the atom-handson-sum-preview:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atomHandsonSumPreviewElement = workspaceElement.querySelector('.atom-handson-sum-preview')
        expect(atomHandsonSumPreviewElement).toExist()

        atomHandsonSumPreviewPanel = atom.workspace.panelForItem(atomHandsonSumPreviewElement)
